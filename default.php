...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://jahdigital-com-br.preview-domain.com/">JaH Digital</a>
        </div>
...
<div class="empty-account-page">
    <div class="container">
        <div class="row congratz">
            <h1>Bem-vindo à página do Jah Digital!</h1><em></em>
        ...
        <div class="footer">
            <div class="row">
                ...
                <div class="copyright text-center">
                    JaH Digital © 2020. Todos os direitos reservados
                </div>
            </div>
        </div>
    </div>
